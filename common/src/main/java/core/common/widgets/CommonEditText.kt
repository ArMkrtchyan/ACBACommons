...
import core.common.shared.extensions.isValidEmail
import core.common.shared.extensions.isValidPassword
import core.common.shared.extensions.isValidRegex
import core.common.validators.Validator
import core.common.validators.ValidatorEnum

class CommonEditText : AppCompatEditText, Validator {
    ...
    fun getTextOrNull(): String? = if (text.isNullOrEmpty()) null else text.toString().trim()
}
